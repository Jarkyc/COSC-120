...
int main()
{
	...
	cout << " PI, RATE, radius, iomanip, iostream, findArea, and findCircumference are active here" << endl << endl;

	{
		float area;

		cout << "Main function first inner block" << endl;
		cout << "PI, RATE, radius, iomanip, iostream, findArea, and findCircumference, area are active here" << endl << endl;
...

	{
		...
		cout << "PI, RATE, radius, iomanip, iostream, findArea, and findCircumference, circumference are active here" << endl << endl;
...
void findArea(float rad, float& answer)
{
	...
	cout << "PI, RATE, iomanip, iostream, findArea, and findCircumference, rad, and area are active here" << endl << endl;
...
void findCircumference(float length, float& distance)
{
	...
	cout << "PI, RATE, iomanip, iostream, findArea, and findCircumference, length, and circumference are active here" << endl << endl;
